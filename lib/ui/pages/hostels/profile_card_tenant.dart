...
class ProfileCardTenant extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        body: hostelDetail.reviews == null ? Container(child: Center(child: Text('ooops, No data', style: Theme.of(context).textTheme.headline6.copyWith(color: yellowColor),),),):  SingleChildScrollView(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          TextButtonWidget(
                            onTap: () {
                              Navigator.of(context).pushNamed(payRentRoute);
                            },
                            text: 'RENT',
